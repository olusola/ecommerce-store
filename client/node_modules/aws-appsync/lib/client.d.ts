...
declare class AWSAppSyncClient<TCacheShape> extends ApolloClient<TCacheShape> {
    ...
    constructor({ url, region, auth, conflictResolver, complexObjectsCredentials, cacheOptions, disableOffline }: AWSAppSyncClientOptions, options?: Partial<ApolloClientOptions<TCacheShape>>);
